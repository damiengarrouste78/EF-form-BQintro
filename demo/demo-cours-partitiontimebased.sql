...
-- partitionner
-- 10/2020
-- Exemple d'apres google
--======================================================================================================================


--1 REQUETE DE DEPART -- Durée moyenne par stations sur les réservations 

-- https://cloud.google.com/bigquery/docs/creating-column-partitions?hl=en#creating_a_partitioned_table_from_a_query_result

-- Cette requête coute 1 go ce qui est assez gros
...
'
;
--3 relancer la requete en interactif
